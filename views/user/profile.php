        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
            ...
            <div>
                ...
                <div style="font-size: 20px; font-weight: 600;">
                    <span class="badge badge-success" style="font-size: 16px;">Usuário</span>
                </div>
            </div>
...
<div class="card">
    ...
    <div style="padding: 20px;">
        <p style="color: #666; margin-bottom: 20px;">
            Escolha um plano para renovar sua conta:
        </p>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px;">
            <div style="border: 2px solid #e5e7eb; border-radius: 8px; padding: 20px; text-align: center;">
                ...
                <div style="font-size: 32px; font-weight: 700; color: #667eea; margin-bottom: 15px;">R$ 30,00</div>
                <button onclick="initiatePayment(30, 30)" class="btn" style="width: 100%;">Escolher</button>
            </div>
            
            <div style="border: 2px solid #e5e7eb; border-radius: 8px; padding: 20px; text-align: center;">
                <div style="font-size: 18px; font-weight: 600; margin-bottom: 10px;">60 Dias</div>
                <div style="font-size: 32px; font-weight: 700; color: #667eea; margin-bottom: 15px;">R$ 55,00</div>
                <button onclick="initiatePayment(60, 55)" class="btn" style="width: 100%;">Escolher</button>
            </div>
            
            <div style="border: 2px solid #e5e7eb; border-radius: 8px; padding: 20px; text-align: center;">
                <div style="font-size: 18px; font-weight: 600; margin-bottom: 10px;">90 Dias</div>
                <div style="font-size: 32px; font-weight: 700; color: #667eea; margin-bottom: 15px;">R$ 75,00</div>
                <button onclick="initiatePayment(90, 75)" class="btn" style="width: 100%;">Escolher</button>
            </div>
        </div>
    </div>
</div>
...
<div class="card">
    ...
    <div class="alert alert-info">
        Entre em contato com seu revendedor ou administrador para renovar seu acesso.
    </div>
</div>
<?php endif; ?>
...
<div class="card">
    ...
    <form id="password-form" style="max-width: 500px; padding: 20px;">
    ...
    <div id="password-alert" style="margin-top: 20px; padding: 0 20px 20px;"></div>
</div>
